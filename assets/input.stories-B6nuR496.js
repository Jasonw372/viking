import{j as Z}from"./jsx-runtime-WdPq8kIh.js";import{I as Q}from"./input-BXKUA6Au.js";import{r as $}from"./index-BpYrhlGc.js";import"./index-C5kWM00b.js";import"./index-yDvlI-tm.js";const oe={title:"Components/Input",component:Q,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{size:{control:"select",options:["lg","sm",void 0]},prefixIcon:{control:"text"},suffixIcon:{control:"text"},prepend:{control:"text"},append:{control:"text"}}},a={args:{placeholder:"请输入内容",disabled:!1,defaultValue:"123"},name:"默认输入框"},r={args:{placeholder:"请输入内容",disabled:!1,type:"password",defaultValue:"123"},name:"密码输入框"},s={args:{disabled:!0},name:"不可用的输入框"},n={args:{size:"lg"},name:"大号输入框"},o={args:{size:"sm"},name:"小号输入框"},t={args:{prefixIcon:"search",suffixIcon:"times",placeholder:"请输入搜索内容"},name:"带前缀和后缀图标的输入框"},c={args:{suffixIcon:"search",placeholder:"带后缀图标的输入框",value:"123"},name:"带后缀图标的输入框"},p={args:{prefixIcon:"user",placeholder:"带前缀图标的输入框"},name:"带前缀图标的输入框"},d={args:{prepend:"https://",append:".com"},name:"前后缀的输入框"},l={args:{prepend:"123",append:"Status",size:"lg",defaultValue:"12343142"},name:"复杂前后缀的输入框"},e=()=>{const[U,X]=$.useState("");return Z.jsx(Q,{value:U,onChange:Y=>X(Y.target.value)})};e.storyName="受控输入框";e.parameters={controls:{disable:!0},actions:{disable:!0}};const m={args:{prefixIcon:"search",suffixIcon:"keyboard",prepend:"https://",append:".com",placeholder:"请输入搜索内容",defaultValue:"baidu"},name:"带前后缀和图标的输入框"};e.__docgenInfo={description:"",methods:[],displayName:"Controlled"};var u,i,g;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...
  name: '不可用的输入框'
}`,...(b=(S=s.parameters)==null?void 0:S.docs)==null?void 0:b.source}}};var V,v,y;n.parameters={...n.parameters,docs:{...(V=n.parameters)==null?void 0:V.docs,source:{originalSource:`{
  args: {
    size: 'lg'
  },
  name: '大号输入框'
}`,...(y=(v=n.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var C,W,z;o.parameters={...o.parameters,docs:{...(C=o.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    size: 'sm'
  },
  name: '小号输入框'
}`,...(z=(W=o.parameters)==null?void 0:W.docs)==null?void 0:z.source}}};var A,P,w;t.parameters={...t.parameters,docs:{...(A=t.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    prefixIcon: 'search',
    suffixIcon: 'times',
    placeholder: '请输入搜索内容'
  ...
  name: '带前后缀和图标的输入框'
}`,...(M=(K=m.parameters)==null?void 0:K.docs)==null?void 0:M.source}}};const te=["Default","Password","Disabled","Large","Small","WithIcons","WithSuffixIcon","WithPrefixIcon","P","ComplexAddons","Controlled","WithIconsAndAddons"];export{l as ComplexAddons,e as Controlled,a as Default,s as Disabled,n as Large,d as P,r as Password,o as Small,t as WithIcons,m as WithIconsAndAddons,p as WithPrefixIcon,c as WithSuffixIcon,te as __namedExportsOrder,oe as default};
